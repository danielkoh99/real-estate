...
Property.init(
    ...
    },
    {
        ...
        paranoid: true,
        indexes: [
            { name: "idx_city_type_price", fields: ["city", "type", "price"] },
            { name: "idx_district_price", fields: ["district", "price"] },
            { name: "idx_price", fields: ["price"] },
            { name: "idx_size", fields: ["size"] },
            { name: "idx_bedrooms", fields: ["bedrooms"] },
            { name: "idx_booleans", fields: ["hasGarden", "hasTerrace", "parkingSpace", "petFriendly"] },
...
Property.addHook("beforeUpdate", async (property) => {
    ...
    property.setDataValue("oldPrice", oldPrice);
